(() => {
  ...
  const PATHS = {
    'linha': [[[0.12, 0.50], [0.32, 0.50], [0.54, 0.50], [0.78, 0.50], [0.90, 0.50]]],
    'subida': [[[0.18, 0.78], [0.34, 0.62], [0.50, 0.46], [0.66, 0.30], [0.82, 0.16]]],
    'montanha': [[[0.10, 0.72], [0.28, 0.28], [0.46, 0.72], [0.64, 0.28], [0.86, 0.72]]],
    'onda': [[[0.08, 0.54], [0.20, 0.32], [0.34, 0.54], [0.48, 0.76], [0.62, 0.54], [0.76, 0.32], [0.90, 0.54]]],
    'curva': [[[0.18, 0.24], [0.12, 0.42], [0.18, 0.66], [0.38, 0.78], [0.62, 0.72], [0.82, 0.52], [0.84, 0.28]]],
    'espiral': [[[0.18, 0.52], [0.28, 0.30], [0.54, 0.20], [0.78, 0.34], [0.82, 0.58], [0.64, 0.76], [0.40, 0.72], [0.30, 0.54], [0.42, 0.40], [0.58, 0.42], [0.62, 0.54]]]
  };

  class PrewritingTrailsScene extends window.AprincarBaseScene {
    nextRound() {
      this.clearRound();
      ...
      this.promptText.setText(`Siga o caminho: ${key.replaceAll('-', ' ')}`);
      ...
      if (start) {
        ...
        const markerText = this.add.text(start.x + 16, start.y - 11, 'comece', {
  ...
  new Phaser.Game(window.createAprincarPhaserConfig(PrewritingTrailsScene));
})();
